<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageTutor.master" AutoEventWireup="true" CodeFile="PreparazioneCorso.aspx.cs" Inherits="Default2" %>
    ...
    <table>
        <tr>
            <td>
                ...
                <asp:DropDownList ID="ddlCorsi" runat="server"></asp:DropDownList>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Button ID="Button4" runat="server" Text="Duplica" OnClick="btnSelezionaCorso_Click" />
            </td>
        </tr>
        <tr>
            <td>
